...
try:
    ...
    class SignedOrder:  # type: ignore
        """
        Minimal placeholder so modules can import clob_types without
        py_order_utils installed. Any attribute access on real order objects will
        fail unless the dependency is installed.
        """

        def __init__(self, *args, **kwargs):
            raise ModuleNotFoundError(
                "py_order_utils is required for SignedOrder support. "
