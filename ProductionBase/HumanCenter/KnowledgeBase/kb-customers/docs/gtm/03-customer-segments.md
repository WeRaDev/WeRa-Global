...
## Purpose
Define Human Center's validated target customer segments for Product 1 ("Shrinking AI") and go-to-market approach.
...
## Decisions / Rules
- Do not position or price Human Center as a PE-fund-facing AI vendor; if an A4 client's own clients happen to be investment funds, the buyer is still the solo consultant, not the fund.
