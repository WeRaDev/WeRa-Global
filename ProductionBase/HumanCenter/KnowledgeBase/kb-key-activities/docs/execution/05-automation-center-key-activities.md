...
## Purpose
List Product 3 ("Automation Center")'s core delivery activities.

## Scope
- In scope: activities from discovery interview through build, deployment, and support retainer.
- Out of scope: Shrinking AI's session-flow activities (`04-key-activities.md`); Product 2 activities.
...
- Do not skip the compliance/data-owner route for any client whose data may be regulated or confidential (financial-advisory, investment-fund-adjacent).
