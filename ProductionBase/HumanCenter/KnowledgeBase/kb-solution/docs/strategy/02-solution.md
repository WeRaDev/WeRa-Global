...
## Purpose
Describe Human Center's Product 1 ("Shrinking AI") solution approach to the problem in `../../../kb-problem/docs/market/01-problem.md`.
...
## Cross-Domain Links
- Related domains: `kb-problem`, `kb-value-proposition`, `kb-key-activities`, `kb-unfair-advantage`
- Related documents: `../../../kb-problem/docs/market/01-problem.md`, `../../../kb-value-proposition/docs/products/02-services.md`, `../../../kb-key-activities/docs/execution/04-key-activities.md`, `../../../kb-unfair-advantage/docs/strategy/10-unfair-advantage.md`

## Open Actions
- Run heuristic evaluation against the competitor tools already named in desk research (Hartz AI, AI Jungle, Agentyis, McKinsey, Accenture), owner: Founder/Consultant, due: before first pilot.
- Build and test a fragment of the RCGFC framework as an on-site interactive preview, owner: Founder/Consultant, due: see `../../../../tasks/backlog.md` HC-006.
