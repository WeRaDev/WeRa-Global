...
- Out of scope: a built-automation tech stack (not the core product; see `../../../kb-solution/docs/strategy/02-solution.md`) — that stack is Product 3 ("Automation Center")'s own resource set, see `06-automation-center-key-resources.md`.
...
## Decisions / Rules
- No workflow-automation vendor/stack (n8n/Make/Zapier) is required for Shrinking AI itself; that stack is Product 3 ("Automation Center")'s resource, not Shrinking AI's core session product.
...
- `../../../../Resources/Documents/Research/HumanCenter.Pricing.md` — verified as Product 3 ("Automation Center")'s own resource evidence (n8n/Make/Zapier + LLM APIs); not part of Shrinking AI's resource set.
