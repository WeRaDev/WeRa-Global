...
## Decisions / Rules
- The workflow-automation stack (n8n/Make/Zapier + LLM APIs) is a committed resource for Automation Center, unlike its "candidate, not yet committed" status under Human Center's Shrinking AI.
