...
**Near-term focus and cross-sell (Sept 2026):** as with Automation Center generally, Financial Automation is currently in discovery-only mode with founder-led manual sessions (no pilot signed yet), and follows the Automation-Center-leads cross-sell direction — a Financial Automation engagement, once signed, may be followed by attaching Human Center consultancy, not the reverse (see `03-automation-center.md`).
...
## Open Actions
- Run discovery interviews with real financial-industry prospects to validate the two client profiles above, owner: Founder/Consultant.
