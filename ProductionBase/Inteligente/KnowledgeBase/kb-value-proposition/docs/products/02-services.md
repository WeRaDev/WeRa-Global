...
- Out of scope: Empowering Human, Human Center's other service (see `05-empowering-human.md`); the Automation Center product line (see `03-automation-center.md`); pricing of the paid session (see Open Actions and `../../../kb-revenue-streams/docs/model/07-revenue-streams.md`).
...
## Cross-Domain Links
- Related domains: `kb-solution`, `kb-revenue-streams`, `kb-customers`, `kb-unfair-advantage`
- Related documents: `../../../kb-solution/docs/strategy/02-solution.md`, `../../../kb-revenue-streams/docs/model/07-revenue-streams.md`, `../../../kb-customers/docs/gtm/03-customer-segments.md`

## Open Actions
- Set and document pricing for the paid structured session — no source establishes a price for this specific deliverable yet, owner: Founder/Consultant, due: see `../../../../tasks/backlog.md` HC-003.
- Produce the first proof assets: 10+ completed sessions, 3 case write-ups, and a consent evidence pack (all currently listed as missing), owner: Founder/Consultant.
