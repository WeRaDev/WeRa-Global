...
- consolidation_source: `_kb-split-migration/kb-governance/docs/open-questions/12-open-questions.md`
- consolidation_date: `2026-04-17`
- consolidation_status: `canonicalized`

## SPLIT-09 Metadata Contract
- primary_domain: `governance`
- secondary_domains: `customers`, `key-partners`, `revenue-streams`, `metrics`
- temporal_scope: `mixed`
- evidence_status: `gap-register`
- upstream dependencies: `kb-metrics/docs/financial/13-financial-model.md`, `kb-revenue-streams/docs/model/03-business-model.md`
- downstream dependencies: governance review events and remediation tasks
- validation hooks: `chain.metrics_to_open_questions.exception_routed`, `contradictions.owner_due_action_present`, `review.routing.temporal_scope_present`
- provenance:
  - actor: `WARP`
  - source: `KnowledgeBase/12-Open-Questions.md@4c119831435ea9e39242278f2f639ccbcac5282f`
  - confidence: `direct-transfer-with-normalization`
  - review_status: `pending-entity-review`
- chain_link: `metrics -> open-questions`

## Pilot-chain contradiction routing (SPLIT-09)
- contradiction_id: `Q31`
- owner: `governance council delegate`
- due_action: Publish canonical qualification/pricing rule and exception path in `kb-revenue-streams/docs/model/03-business-model.md` and update this register after decision.
- due_date: `2026-04-24`
- status: `routed`
