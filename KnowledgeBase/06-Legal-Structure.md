# Compatibility Stub — 06-Legal-Structure.md

This legacy path is retained for compatibility during KB canonicalization.

canonical_reference:
  path: KnowledgeBase/kb-governance/docs/legal/06-legal-structure.md
  status: canonical
  last_verified: 2026-04-27

migration:
  source: KnowledgeBase/06-Legal-Structure.md
  mode: move
  owner_role: governance-steward
